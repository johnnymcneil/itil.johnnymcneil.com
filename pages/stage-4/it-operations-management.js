...
export default function ITOperationsManagement() {
  const stage = 4
  const process = 0
  const title = 'IT Operations Management'
  ...
  return (
    <>
      ...
      <Layout>
        <main>
          <h1 data-heading="IT Operations Management">IT Operations Management</h1>
          ...
          <p><a data-href="Application Management" href="D:\Black Mesa Transit\Obsidian\IT ServiceNow Bootcamp\ITIL Overview\Five Stages of ITIL Service Lifecycle\Stage 4\Application%20Management.html" class="internal-link" target="_blank" rel="noopener">Application Management</a></p>
          <hr />
